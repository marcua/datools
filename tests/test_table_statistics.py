...
def test_table_statistics():
    ...
    assert {
        Column('id'):
            [SetValuedStatistics(171), RangeValuedStatistics([1, 58, 115])],
        ...
        Column('same_int'):
            [SetValuedStatistics(1), RangeValuedStatistics([1])],
        Column('unique_int'):
            [SetValuedStatistics(171), RangeValuedStatistics([
                1001, 7004, 13007])],
        Column('bucket_unique_int'):
            [SetValuedStatistics(9), RangeValuedStatistics([
                1, 4, 7])],
    } == statistics
